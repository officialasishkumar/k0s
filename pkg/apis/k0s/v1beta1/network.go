...
func (n *Network) Validate() []error {
	...
	if validCIDRs {
		...
		// https://github.com/kubernetes/kubernetes/blob/v1.36.0-beta.0/cmd/kube-apiserver/app/options/validation.go#L52-L58
	...
	if n.DualStack.Enabled {
		...
		if err != nil {
			...
			// https://github.com/kubernetes/kubernetes/blob/v1.36.0-beta.0/cmd/kube-apiserver/app/options/validation.go#L39
			maxCIDRBits := 20
